...
<!-- SECONDARY HERO -->
    <section class="secondary-header-2" id="">
        <div class="container-fluid parallax-container">
            <div class="row">
                <div class="parallax-window" data-parallax="scroll" data-image-src="/img/games_header.jpg">
        ...
        <div class="container">
            ...
            <div class="row">
                    <a href="/product_catalog/toys.cfm" class="col-md-4 col-sm-6 awards-wrapper text-center">
                            ...
                            <div>
                            <img src="../img/toys.jpg" class="explore-img img-responsive center-block img-circle" alt="Toys">
                            </div>
                            <div class="caption text-center">
                            </div>
                            <button type="button" class="split-section-button btn btn-round-lg btn-lg">Discover Toys  &nbsp;&rsaquo;</button>
                    </a>
                    <a href="/product_catalog/brain_teasers.cfm" class="col-md-4 col-sm-6 awards-wrapper text-center">
                            <h2 class="explore-label">Brain Teasers</h2>
                            <div>
                            <img src="../img/brainteasers.jpg" class="explore-img img-responsive center-block img-circle" alt="brainteasers">
                            </div>
                            <div class="caption text-center">
                            </div>
                            <button type="button" class="split-section-button btn btn-round-lg btn-lg">Discover Brain Teasers  &nbsp;&rsaquo;</button>
                    </a>
                    <a href="/product_catalog/education.cfm" class="col-md-4 col-sm-12 awards-wrapper text-center">
