        ...
        <div class="container meet-fat-brain-container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    <h2 class="section-heading meet-fat-brain-heading">Meet Fat Brain<br>Toy Co.</h2>
                    <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ac iaculis eros. Nunc at erat diam. Cras fermentum elit et sem tempor tempus. </p>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-6 col-sm-pull-6">
                    ...
                    <p class="split-section-p">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ac iaculis eros. Nunc at erat diam. Cras fermentum elit et sem tempor tempus. </p>
...
<!-- HAVE A TOY DESIGN -->
    <section class="toy-design-section" id="">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <a href="#" class="toy-design-btn btn btn-default btn-xl">                    
